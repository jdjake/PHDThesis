...
%
Applying Lemma \ref{lemma:scaleupbound} with $l$ and $k$ as above, $C(z_0,t_0) = \langle 2^k t_0 \rangle^{- \frac{d-1}{2}} \| b_{t_0} \|_{L^1(X)} \| U_{z_0} \|_{L^1(X)}$, and with $U_{z_0} = \sum\nolimits_H A_{\alpha,k,H,Q(z_0)}$, we conclude that %where $W = [z_0, z_0 + 2^{l-k}]$ we conclude that
% W^{1/p - 1}
\begin{align*}
