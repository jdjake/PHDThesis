...
Our methods do not take advantage of the rotational symmetries of $S^d$, and can thus be applied in greater generality, to spectral multipliers of a self-adjoint elliptic pseudo-differential operator $P$, under assumptions related to the curvature of level sets of the principal symbol of $P$, and the periodicity of a Hamiltonian flow associated with $P$.
...
The characterizations of $L^p$ boundedness for compactly supported and regulated functions are adapted from a paper of the author, with the methods of combining frequency scales taken from forthcoming work.